...
val clone_post_result : ?loc:Loc.position -> ?attrs:Sattr.t -> post -> preid
val result_id : ?loc:Loc.position -> ?attrs:Sattr.t -> ?ql:post list -> unit -> preid
(** [result_id ?loc ?attrs ?ql ()] returns a fresh pre-identifier whose name
